        ...
        <div className="bg-gradient-to-br from-[#0d022d] via-[#1a063d] to-[#080d24] w-full h-[80vh] rounded-xl flex flex-col justify-center items-center gap-3">
          ...
          >
            ...
            <button
              ...
              name="github"
              type="button"
              className="cursor-pointer text-white hover:scale-[1.02] w-[80%] pl-5 bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 me-2 mb-2 font-sans"
            >
              <svg
                className="w-4 h-4 me-2 pointer-events-none"
                aria-hidden="true"
            ...
            <button
              ...
              name="google"
              type="button"
              className="cursor-pointer text-white hover:scale-[1.02] w-[80%] pl-5 bg-[#4285F4] hover:bg-[#4285F4]/70 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2 font-sans"
            >
              <svg
                className="w-4 h-4 me-2 pointer-events-none"
                aria-hidden="true"
